...
public class SongInfo {
	...
	public SongInfo(String pic_huge, String album_1000_1000,
			String album_500_500, String compose, String toneid,
			String bitrate, String artist_500_500, String file_duration,
			String album_title, String sound_effect, String title,
			String high_rate, String pic_radio, String lrclink,
			String distribution, String pic_big, String pic_premium,
			String artist_480_800, String artist_id, String album_id,
			String versions, String ting_uid, String artist_1000_1000,
			String all_artist_id, String artist_640_1136, String publishtime,
			String songwriting, String share_url, String author,
			String has_mv_mobile, String all_rate, String pic_small,
			String song_id) {
		super();
